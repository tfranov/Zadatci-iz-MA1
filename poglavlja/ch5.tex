...
\begin{itemize}
\item[a)] Koliko ima prirodnih brojeva \(n\in \mathbb{N}\) za koje vrijedi
\[\dfrac{2n}{n+1}-\dfrac{3}{2^n}-\dfrac{1}{n}-\dfrac{2}{n^4}>1?\]
Dokažite svoje tvrdnje! (\textbf{Uputa:} Iskoristite definiciju limesa niza.)
\item[b)] Dokažite da $x\mapsto 2^x$ nije polinom. (\textbf{Uputa:} Pretpostavite suprotno i promatrajte niz $n\mapsto \dfrac{P(n)}{2^n}$, gdje je $P$ polinom. Kako je ovo kvocijent dva polinoma, možemo li nešto zaključiti o njihovim stupnjevima?)
\end{itemize}
\end{exercise}
\begin{exercise} \((**)\)
...
\end{exercise}
\begin{exercise}
Neka je \((a_n)\) konvergentan niz s limesom u \(a\in \mathbb{R}\) i neka je \((b_n)\) niz takav da je \(b_{2n-1}=a_{2n-1}\) i \(b_{2n}=a_{2n}+1\), za sve \(n\in \mathbb{N}\). Odredite skup svih gomilišta niza \((b_n)\).
\end{exercise}
\begin{exercise}
