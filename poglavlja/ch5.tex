...
\end{proof}
\begin{exercise}{Zadatak}
Neka je $(a_n)$ niz takav da postoji $c>0$ takvi da za sve $n\in \mathbb{N}$ vrijedi
$$\lvert x_2-x_1\rvert+\lvert x_3-x_2\rvert+\dots+\lvert x_n-x_{n-1}\rvert<c.$$
Dokažite da niz $(a_n)$ konvergira.
\end{exercise}
\begin{proof}[Rješenje]
Iz uvjeta zadatka naslućujemo da je niz Cauchyjev. Zaista, neka je $\epsilon>0$, te neka je $(y_n)$ niz zadan s
