...
\item[d)] $\lim\limits_{n\to\infty}{\dfrac{n}{n+2^n}}=0$
...
\item[b)] Neka je $(a_n)$ niz realnih brojeva. Vrijedi $$\lim\limits_{n\to \infty}{a_n}=a\;\text{ ako i samo ako vrijedi }\;\lim\limits_{n\to \infty}{|a-a_0|}=0$$
\textbf{DOVRŠITI!!!}
\end{itemize}
\end{exercise}
