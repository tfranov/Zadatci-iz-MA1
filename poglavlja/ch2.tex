...
\end{align*}
\end{proof}
\begin{exercise}{Zadatak}[Županijsko natjecanje, 3. razred, A varijanta, 2013.] Dokažite da je \(\cos{\dfrac{\pi}{2\cdot 3^n}}\) iracionalan za sve \(n\in \mathbb{N}\).
\end{exercise}
\begin{proof}
...
\end{proof}
\begin{exercise}{Zadatak}[Županijsko natjecanje, 4. razred, A varijanta, 2015.]
...
\begin{exercise}{\input{easy.tex}\unskip} Zapišite sljedeće sudove u terminima predikata, kvantifikatora i veznika.
\begin{itemize}
...
\end{itemize}
\end{exercise}
\begin{exercise}{\input{easy.tex}\unskip}
...
\end{exercise}
\subsection*{Skupovi}
\begin{exercise}{\input{easy.tex}\unskip} Zapišite sljedeće skupove matematičkim simbolima. Po potrebi koristite i skupovne operacije (unija, presjek, razlika skupova, simetrična razlika).
\begin{itemize}
...
\begin{exercise}{\input{easy.tex}\unskip} Dokažite sljedeće tvrdnje ako su istinite ili dajte kontraprimjer ako nisu.
\begin{itemize}
...
\end{itemize}
\end{exercise}
\begin{exercise}{\input{easy.tex}\unskip} Dokažite sljedeće tvrdnje \textit{direktno}.
\begin{itemize}
...
\end{itemize}
\end{exercise}
\begin{exercise}{\input{easy.tex}\unskip} Dokažite sljedeće tvrdnje \textit{kontrapozicijom}.
\begin{itemize}
...
\end{itemize}
\end{exercise}
\begin{exercise}{\input{easy.tex}\unskip} Dokažite sljedeće tvrdnje \textit{kontradikcijom}.
\begin{itemize}
...
\end{itemize}
\end{exercise}
\begin{exercise}{\input{medium.tex}\unskip} Dokažite sljedeće tvrdnje.
\begin{itemize}
...
\item[c)] Dokažite da je \(\sqrt{27}\) iracionalan. (\textbf{Uputa:} Provedite postupak slično kao u rješenju zadatka \ref{classiccontradictionproof}.)
...
\item[d)] Dokažite da za sve \(n\in \mathbb{N}\) vrijedi \(8 \mid 3^n-2n^2-1\). (\textbf{Uputa:} Provedite matematičku indukciju više puta.)
\item[e)] Odredite najmanji prirodan broj \(a>1\) takav da vrijedi
\[a \mid 2^{6n-1}+5\cdot 9^n,\; \forall n\in \mathbb{N}.\]
\end{itemize}
\end{exercise}
\begin{exercise}{\input{medium.tex}\unskip} Naslutite odgovore na iduće zadatke i dokažite svoje slutnje matematičkom indukcijom.
\begin{itemize}
...
\begin{exercise}{\input{medium.tex}\unskip} U ravnini je zadano \(n\) pravaca tako da se nikoja tri ne sijeku u jednoj točki i nikoja dva nisu međusobno paralelna.
\begin{itemize}
...
\end{exercise}
\begin{exercise}{\input{hard.tex}\unskip}[Županijsko natjecanje, 4. razred, A varijanta, 2017.]
...
\end{definition}
\begin{exercise}{\input{hard.tex}\unskip}[Županijsko natjecanje, 4. razred, A varijanta, 2013.] \((*)\)
Dokažite da je broj čiji se dekadski zapis sastoji od 2187 znamenki 1 djeljiv s 2187.
\end{exercise}
\begin{exercise}{\input{hard.tex}\unskip}[Županijsko natjecanje, 4. razred, A varijanta, 2016.] \((*)\)
