...
gdje posljednje očigledno vrijedi, jer vrijedsi \(3n>n+1\Leftrightarrow 2n>1\Leftrightarrow n>\dfrac{1}{2}\), što vrijedi za sve \(n\in \mathbb{N}\).
\end{proof}
\begin{remark}
\label{21}
...
\begin{exercise} \textbf{}
\begin{itemize}
\item[a)] Neka su \(a, b\in \mathbb{Z}\) parni brojevi takvi da je \(a<b\). Dokažite da postoji \(n\in \mathbb{Z}\) takav da je \(a<n<b\).
\item[b)] Neka je \(a\in \mathbb{N}\), \(a>1\). Dokažite da ne postoji \(n\in \mathbb{N}\) sa svojstvom da \(a \mid n\) i \(a \mid n+1\).
\item[c)] Neka je \(a>0\) i \(b\in \mathbb{R}\). Dokažite da vrijedi \(b>a\) ako i samo ako postoji \(\epsilon>0\) takav da je \(b=(1+\epsilon)a\).
\end{itemize}
\end{exercise}
\begin{exercise}
